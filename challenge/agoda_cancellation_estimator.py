...
class AgodaCancellationEstimator(BaseEstimator):
    ...
    def __init__(self, regressor_scale_x=True, regressor_scale_y=True, classifier_scale_x=True,
                 classifier_scale_y=True) -> AgodaCancellationEstimator:
        """
        ...
        self.classifier_scale_y = classifier_scale_y
    ...
    def _predict_classifier(self, X: np.ndarray) -> np.ndarray:
        if self.classifier_scale_x:
            scale_X = self.classifier_scale_x.transform(X)
